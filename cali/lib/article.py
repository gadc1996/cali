...
class Article:
    ...
    def __init__(self, iterable):
        self.id = self._is_valid(iterable['id'], 'id')
        self.name = self._is_valid(iterable['name'], 'name')
        #self.category = self._is_valid(iterable['category'], 'category')
        ...
        self.category = get_single_category(iterable['category_id'])
    ...
    def delete_article(self, id):
     return f'DELETE FROM article WHERE article.id={id}'
